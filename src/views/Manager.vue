  ...
  <div>
    <el-container>
      ...
      <el-aside :width="asideWidth" style="min-height: 120vh; background-color:#001529"><!--100vh相当于窗口当前高度-->
        <div
            style="height: 60px;line-height: 60px;color: aqua;display: flex;align-items: center;justify-content: center">
          <img src="@/assets/logo1.jpg" style="width: 40px;height: 40px">
          <span class="logo-title" v-show="!isCollapse">毕业设计</span>
        </div>

        <el-menu :default-openeds="['info','info1','info2']" :collapse="isCollapse" :collapse-transition="false" router
                 background-color="#001529" text-color="rgba(255,255,255,0.65)"
                 active-text-color="#fff" style="border: none " :default-active="$route.path">
          <!--$route.path当前浏览访问的路由;router点击;collapse水平折叠菜单;collapse-transition收缩栏动画-->
